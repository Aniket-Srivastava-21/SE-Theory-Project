      ...
      <div className="row m-5 border d-sm-flex flex-wrap justify-content-between bg-light border-dark p-3">
        <div className="col-9 bg-white p-3 shadow p-3 mb-5 bg-body rounded">
          ...
          <div className=" my-3">
              ...
              <table className="table ">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>4%</td>
                    <td>
                      Physics, technology and society, SI units, Fundamental and
                      derived units. Least count, accuracy and precision of
                      measuring instruments, Errors in measurement, Dimensions
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      position-time graphs, relations for uniformly accelerated
                      motion. Scalars and Vectors, Vector addition and
                      Subtraction, Zero Vector, Scalar and Vector products, Unit
                      Vector, Resolution of a Vector. Relative Velocity, Motion
                      in a plane. Projectile Motion, Uniform Circular Motion.
                    </td>
                  </tr>
                  <tr>
                    <th scope="row">3</th>
                    ...
                    <td>
                      ...
                      Dynamics of uniform circular motion: Centripetal force and
                      its applications,
                    </td>
                  </tr>
                  <tr>
            ...
            <div className="collapse" id="resourceExample">
              <ul className="list-unstyled">
                <li className="media">
                  <div className="media-body">
                    <h5 className="mt-0 mb-1">1. Kinetic Energy</h5>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Expedita earum ratione fugiat et, numquam aliquid
                    necessitatibus alias dignissimos impedit iure recusandae
                    corporis consequatur obcaecati nostrum distinctio similique
                    non! Incidunt, recusandae?.
                  </div>
                  <a
          ...
          >
            <div className="card-body">
              <h5 className="card-title">
                <i class="bi bi-megaphone-fill"></i> Anouncement
              </h5>
              <hr />
